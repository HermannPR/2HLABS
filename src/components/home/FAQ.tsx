      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((num, index) => (
            ...
            >
              <button
                onClick={() => setOpenId(openId === `faq${num}` ? null : `faq${num}`)}
              ...
              >
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-white pr-8">{t(`faq.faq${num}.question`)}</h3>
                  <motion.div
                    animate={{ rotate: openId === `faq${num}` ? 180 : 0 }}
                ...
                <AnimatePresence>
                  {openId === `faq${num}` && (
                    ...
                    >
                      <p className="text-gray-400 mt-4 leading-relaxed">{t(`faq.faq${num}.answer`)}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </button>
